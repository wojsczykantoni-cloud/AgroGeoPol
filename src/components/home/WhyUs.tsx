    ...
    <section className="py-24 bg-[#0A0F0A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-sm font-semibold text-[#C0392B] uppercase tracking-widest mb-3">Dlaczego my?</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {reasons.map((reason, i) => (
            <AnimateOnScroll key={reason.title} animation="fade-up" delay={i * 100}>
              <div className="h-full card-dark rounded-xl p-5 flex flex-col gap-3 transition-all duration-300 hover:border-[#C0392B]/30 hover:-translate-y-0.5">
                <div className="w-10 h-10 rounded-lg bg-[#C0392B]/10 flex items-center justify-center">
                  <reason.icon size={20} className="text-[#C0392B]" />
                </div>
